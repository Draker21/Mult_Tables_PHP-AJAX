...
<!-- HEADER -->
    <header>
        <nav class="fixed-top">
            <ul class="Montserrat-bold fs-25 d-flex justify-content-around align-items-center">
...
<!-- PART 1 RANDOM -->
        <section id="sectionrandom" class="bg-img h100 d-flex justify-content-around">
            <div class="w50 d-flex align-self-center column text-justify m-auto">
                ...
                <p class="Montserrat white fs-20">Le but est simple : à chaque visite sur notre site, nommer la table apparente à votre interlocuteur et
                   demander lui de l'écrire entièrement sur un cahier (ou autres) pour mesurer ses acquis de la session précédente.
                </p>
            </div>
            <div class="w40 d-flex align-self-center mlr-auto">
...
<section class="flex justify-content">
            <h2>Les données disponibles #3</h2>
